...
// By default suppresses the walkthrough tour so it doesn't block other tests.
// Pass { suppressWalkthrough: false } in walkthrough-specific tests.
export async function jumpToApp(page, { suppressWalkthrough = true } = {}) {
  if (suppressWalkthrough) {
